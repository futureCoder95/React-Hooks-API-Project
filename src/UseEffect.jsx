...
const UseEffect = () => {
    ...
    return (
        <>
            <h2 style={{textAlign:'center', color:'red', textDecoration:'underline'}}>List of Github Users</h2>
                                ...
                                <div className="col-10 col-md-4 mt-5" key={curElem.id}>
                                    <div className="card p-2">
                                        <div className="d-flex align-items-center">
                                            <div className="image"><img src={curElem.description} class="rounded" alt="img" width="155" /></div>
                                            <div className="ml-3 w-100">
                                                <h4 className="mb-0 mt-0 textLeft">Saif</h4>
